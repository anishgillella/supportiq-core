...
export default function Step1Registration() {
  ...
  const onSubmit = async (data: RegistrationFormData) => {
    ...
    try {
      ...
      updateFormData({ email: data.email, companyWebsite: data.companyWebsite })

      // Update backend progress to mark step 1 as complete
      await api.updateProgress(response.access_token, { step: 2 })
